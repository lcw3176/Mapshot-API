...
import com.mapshot.api.application.notice.NoticeService;
...
public class NoticeController {
    ...
    public ResponseEntity<NoticeListResponse> showNoticeList(
        ...
        NoticeListResponse noticeListResponses = noticeService.getList(page);
    ...
    public ResponseEntity<NoticeDetailResponse> showNotice(
        ...
        NoticeDetailResponse noticeDetailResponse = noticeService.getDetail(postNumber);
